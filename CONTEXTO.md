...
- Reorganizado o painel superior da aba `Controle Mensal` em duas linhas: resumo executivo com saldo em conta, saldo projetado e mes de referencia; operacional com previsto/realizado de entradas e saidas.
- Adicionado suporte a logo em `Rendas recorrentes`, com upload/preview e exibicao na lista e nos itens de renda da aba mensal.
